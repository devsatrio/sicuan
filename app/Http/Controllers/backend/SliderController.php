...
class SliderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('slider')->with('status','Sukses menyimpan data');
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('slider')->with('status','Sukses memperbarui data');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('slider')->with('status','Sukses menghapus data');
    }
}
