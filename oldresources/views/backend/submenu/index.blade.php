                            ...
                            <table id="list-data" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$row->nama}}</td>
                                        <td>{{$row->namamenu}}</td>
                                        <td>{{$row->namahalaman}}</td>
                                        <td>{{$row->status}}</td>
                                        <td class="text-center">
                                            <form action="{{url('submenu/'.$row->id)}}" method="post">
                                                @csrf
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Tambah Data Submenu</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <form action="{{url('submenu')}}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="menu" class="form-control">
                            ...
                            <option value="{{$row2->id}}" @if($row->id_menu==$row2->id) selected
                    ...
                    <div class="form-group">
                        ...
                        <select name="halaman" class="form-control">
                            ...
                            <option value="{{$row2->id}}" @if($row->id_halaman==$row2->id) selected
                                @endif>{{$row2->nama}}</option>
                            @endforeach
                        </select>
                    </div>
